...
class PDF extends FPDF
{
    ...
    function Content()
    {
        ...
        // Buat QR code menggunakan factory
        // Buat QR code menggunakan class QrCode
        ...
        // Tampilkan QR code di atas nama Hj. Rahmawaty
        // Posisi X: 140, Y: posisi saat ini (getY()), lebar: 30mm, tinggi: 30mm
        $this->Image($qrTempPath, 140, $this->GetY(), 30, 30);
        $this->Ln(32); // Beri jarak vertikal setelah QR code
        $this->Cell(100, 0, '', 0, 0);
        $this->SetFont('Times', 'B', 12);
